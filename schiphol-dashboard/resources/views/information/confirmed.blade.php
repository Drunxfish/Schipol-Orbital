            ...
            <div class="d-flex flex-column align-items-center justify-content-center" style="width: 100%;">
                <div class="card border-0 shadow rounded-4 p-5"
                    ...
                    <div class="text-center">
                        ...
                        <h1 class="fw-bold text-success mb-3" style="font-size:3.2rem;">Booking complete!</h1>
                        <div class="text-start mx-auto" style="max-width: 500px;">
                            <p class="text-secondary mb-0" style="font-size:1.6rem;">
                                - Your flight has been booked and further details have been sent to your email address.<br>
                                Please check your inbox (and spam or junk folder) for all the details about your reservation.<br>
                                You can also visit the link provided in your email to view all the details of your flights.
                            </p>
                        </div>
                        <div class="mt-5">
