...
class FlightTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $checkInLocations = [
            'Terminal 1 - Check-in D',
            'Terminal 2 - Check-in E',
            'Terminal 3 - Check-in F',
            'Terminal 1 - Check-in H',
            'Terminal 2 - Check-in I',
            'Terminal 3 - Check-in J'
        ];
        ...
        $id = 100;
        for ($i = 0; $i < 500; $i++) {
            $departureDate = $i > 180 ? (clone $startDate)->addDays($i) : (clone $startDate)->addDays($i);
